In this kata you will create an object which can execute a query written in a simplified form of [Structured Query Language](http://en.wikipedia.org/wiki/SQL) (SQL) against a simple database.
